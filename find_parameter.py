    ...
    with open(csv_file, 'r') as file:
        ...
        for r in reader:
            ...
            while n < 10:
                ...
                removal = 0.0456*(r[0]/10000)-0.1247*(r[1]/500)+0.0120*(r[2]/50)-0.0106*(r[3]/10)+0.0181+bias
                l_in.append(removal)
        ...
        # 重写列
        df.columns = [ 'Drehzahl', 'Vorschub', 'Kraft', 'Winkel', '1_Differenz',
...
print("The recommended process parameter have been saved into csv-file under:\n" + os.getcwd())
